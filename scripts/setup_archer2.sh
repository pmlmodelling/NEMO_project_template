...
yes | rsync -a $SCRIPTS_DIR/core-scripts/runscript_archer2.slurm $SCRIPTS_DIR/runscript.slurm

yes | rsync -a $WORK/RUN/EXP00/runscripts/runscript_archer2.slurm $WORK/RUN/EXP00/runscript.slurm
