...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", help="server_spacing", type=int, default=1)
    parser.add_argument("-m", help="max_servers_per_node", type=int, default=1)
    parser.add_argument("-C", help="num_clients", type=int, default=252)
    parser.add_argument("-g", help="client_gap_interval", type=int, default=0)
    parser.add_argument("-N", help="ncores_per_node", type=int, default=63)
    parser.add_argument("-t", help="time_limit", type=str, default="01:00:00")
    parser.add_argument("-j", help="job_name", type=str, default="AMM7")
    parser.add_argument("-H", help="ignore_header", action='store_false') 
