...
ln -s $INPUT_DIR/DOM/glosea_ini_19930101_vosaline_domain_cfg_co9amm7_MEsL51r10-07.nc $RUN_DIR/restarts/${NAME}_19930101_vosaline.nc
ln -s $INPUT_DIR/DOM/glosea_ini_19930101_votemper_domain_cfg_co9amm7_MEsL51r10-07.nc $RUN_DIR/restarts/${NAME}_19930101_votemper.nc
