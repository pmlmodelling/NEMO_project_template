...
CONTAINS
   ...
   SUBROUTINE compute_one_cell(a0, a1, Sc, beta, g, S, rho_R, rho_LM, &
      ...
      rho_UM = ( rho_R*Q_river - rho_LM*Q_LM + rho_LM*a0*a1*Q_Ut/2._wp ) / &
               ( Q_UM + a0*a1*Q_Ut/2._wp )
